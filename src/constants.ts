...
export const INITIAL_ELEMENTS: AlchemyElement[] = [
  ...
  },
  {
    id: 'organic',
    name: 'Органика',
    description: 'Живая ткань мироздания, пульсирующая жизненной силой. Основа всего, что дышит и растет.',
    icon: '🧬',
    rarity: 'Редкий',
    type: 'Материя',
    state: 'Твердое',
  ...
  },
  {
    id: 'light',
    name: 'Свет',
    description: 'Сияние между мирами. Это присутствие истины и конец всех теней.',
    icon: '✨',
    rarity: 'Эпический',
    type: 'Энергия',
    state: 'Газ',
